...
final class WC_Switro_Blocks extends AbstractPaymentMethodType
{
    ...
    public function get_payment_method_script_handles()
    {
        ...
        wp_add_inline_script(
            ...
            'window.wc = window.wc || {}; window.wc.wcSettings = window.wc.wcSettings || {}; window.wc.wcSettings["switro_gateway_data"] = ' . wp_json_encode([
                'title' => $settings['title'] ?? 'Switro Solana/ETH Wallet',
                'description' => $settings['description'] ?? 'Pay instantly with Switro Solana/ETH Wallet.',
                'ariaLabel' => $settings['title'] ?? 'Switro Solana/ETH Wallet',
    ...
    public function get_payment_method_data()
    {
        $settings = get_option('woocommerce_switro_gateway_settings', []);
        return [
            'title' => $settings['title'] ?? __('Switro Solana/ETH Wallet', 'crypto-payments-by-switro'),
            'description' => $settings['description'] ?? __('Pay instantly with Switro Solana/ETH Wallet.', 'crypto-payments-by-switro'),
            'ariaLabel' => $settings['title'] ?? __('Switro Solana/ETH Wallet', 'crypto-payments-by-switro'),
